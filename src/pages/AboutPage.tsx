            ...
            <AnimatedSection delay={0.2} className="lg:col-span-2 space-y-8">
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-primary-500/20">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  <p>
                    Hi! I'm Michael with M12 Systems, a passionate full-stack
                    developer with over 25 years of experience building web
                    applications that make a difference. My journey into
                    programming started during college when I discovered the
                    power of code to solve real-world problems.
                  </p>
                  <p>
            ...
            <AnimatedSection delay={0.4} className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-primary-500/10 to-secondary-500/10 rounded-2xl p-6 border border-primary-500/20">
                ...
                <p className="text-gray-300 text-sm">
                  I've contributed to over 20 open-source projects and my GitHub
                  streak is currently at 365+ days! I believe in giving back to
